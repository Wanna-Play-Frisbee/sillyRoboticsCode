...
#pragma config(Motor,  port7,           backRightDrive, tmotorVex393_MC29, openLoop)
...
void imeClearAll(){
 //add all IME bois here
}
void imeTwoPack(string motor1, string motor2){
...
public void driveABoi(string motot){
	motor[motot] = ;
}
...
//\\~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~LCD_FUNCTIONS~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//
  ...
  bLCDBacklight = true; //Turn on the Backlight in the LCD
	...
	while (1==1) //Infinite Loop REALLY? wow I didn't know
	{
...
//Lift_Control_Controller 2
	    ...
	    //motor [LeftLiftUD] = -127;
			...
			{
			VertLiftUse = false;
			//motor [LeftLiftUD]= 0; //Stop the motots after detecting that Btn5DXmtr2 has been pressed
			//motor [RightLiftUD]= 0;
	}
